  ...
  return (
    <div id='contact' className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none'>
        ...
        <form onSubmit={onSubmit} className='max-w-2xl mx-auto'>
            ...
            <button type='submit' className='px-8 py-3 w-max flex items-center justify-between gap-2 bg-black/80 text-white rounded-full mx-auto hover:bg-black duration-500 dark:bg-transparent dark:border-[0.5px] dark:hover:bg-darkHover'> 
                Submit now <Image src={assets.right_arrow_bold} alt='Right arrow' className='w-4' />
            </button>
