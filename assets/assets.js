...
export const infoList = [
    { icon: assets.code_icon, iconDark: assets.code_icon_dark, title: 'Languages', description: 'HTML, CSS, React Js, Next Js, Angular, Java, Python' },
    { icon: assets.edu_icon, iconDark: assets.edu_icon_dark, title: 'Education', description: 'Engineering Degree in Software and Intelligent Systems' },
    { icon: assets.project_icon, iconDark: assets.project_icon_dark, title: 'Projects', description: 'I have solid experience working on various projects' }
];
